    ...
    for (ifa = ifAddrStruct; ifa != NULL; ifa = ifa->ifa_next) {
        ...
        if (cmp != 0) {
            ...
            if (flag) {
                ...
                FRENewObject((const uint8_t*) "com.freshplanet.nativeExtensions.NativeNetworkInterface",
                        6,
        ...
        FRESetArrayElementAt(InterfacePropArray, j, getInterfaceProperties(ifa, NetworkInterfaceArray));
...
void AirNetworkInfoExtInitializer(void** extDataToSet, FREContextInitializer* ctxInitializerToSet, FREContextFinalizer* ctxFinalizerToSet) {
...
void AirNetworkInfoExtFinalizer(void* extData) {
